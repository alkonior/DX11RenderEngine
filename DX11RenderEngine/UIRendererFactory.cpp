...
UIRendererFactory::UIRendererFactory(IRenderer* renderer, Renderer::IStateProvider* provider, void* shaderData, size_t dataSize)
	:PipelineFactory(renderer, provider, UIRendererDefines, std::size(UIRendererDefines), shaderData, dataSize, (void*)Vertex2D::InputElements, std::size(Vertex2D::InputElements))
{
