...
namespace GVM
{
    ...
    struct DX12PipelineStateDescription
    {
        ...
        DX12PipelineStateDescription(const DX12PipelineStateDescription&) = default;
        DX12PipelineStateDescription& operator=(const DX12PipelineStateDescription&) = default;

        DX12PipelineStateDescription(DX12PipelineStateDescription&&) = default;
        DX12PipelineStateDescription& operator=(DX12PipelineStateDescription&&) = default;
