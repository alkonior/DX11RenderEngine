...
//
	...
	ID3D11ShaderResourceView* resources[] = { gBuffer.DiffuseSRV, gBuffer.NormalSRV, gBuffer.MetRougAoSRV, gBuffer.EmissiveSRV, gBuffer.WorldPositionSRV, preMap->Srv, convMap->Srv, intMap->Srv };
